(function () {
        ...
        Basic: {
            ...
            searchPopUp: function () {
                ...
                $(".or-canvas-cart-trigger").on("click", function () {
                    $(".or-ofcanvas-cart-wrapper").toggleClass(
                        "or-canvas-cart-on"
                    );
                });
            },
            MobileMenu: function () {
                ...
                if ($(".mobile_menu li.dropdown ul").length) {
                    $(".mobile_menu li.dropdown").append(
                        '<div class="dropdown-btn"><span class="far fa-arrow-right"></span></div>'
                    );
                ...
                jQuery(window).on("load", function () {
                    ...
                    if (filterizd.length) {
                        ...
                        $(".filtr-button").on("click", function () {
                            $(".filtr-button.filtr-active").removeClass(
                                "filtr-active"
                            );
            ...
            MainBanner2: function () {
                ...
                RS_MODULES.modules["revslider71"] = {
                    once:
                        RS_MODULES.modules["revslider71"] !== undefined
                            ? RS_MODULES.modules["revslider71"].once
                            : undefined,
                    init: function () {
                        window.revapi7 =
                            window.revapi7 === undefined ||
                            window.revapi7 === null ||
                            window.revapi7.length === 0
                                ? document.getElementById("rev_slider_7_1")
                                : window.revapi7;
                        if (
                            window.revapi7 === null ||
                            window.revapi7 === undefined ||
                            ...
                            window.revapi7initTry =
                                window.revapi7initTry === undefined
                                    ? 0
                                    : window.revapi7initTry + 1;
                            if (window.revapi7initTry < 20)
                                requestAnimationFrame(function () {
                        ...
                        revapi7.revolutionInit({
                            ...
                            parallax: {
                                levels: [
                                    5, 10, 15, 20, 25, 30, 35, 40, 45, 46, 47,
                                    48, 49, 50, 51, 30,
                                ],
                                type: "scroll",
                                origo: "slidercenter",
                ...
                if ($(".ori-appScreenshotCarousel-container").length) {
                    if ($(".ori-appScreenshotCarousel-container").length) {
                        var swiper = new Swiper(
                            ".ori-appScreenshotCarousel-container",
                            {
                                effect: "coverflow",
                                loop: true,
                                centeredSlides: true,
                    ...
                    init: function () {
                        ...
                        if (
                            ...
                            window.revapi9initTry =
                                window.revapi9initTry === undefined
                                    ? 0
                                    : window.revapi9initTry + 1;
                    ...
                    init: function () {
                        ...
                        if (
                            ...
                            window.revapi10initTry =
                                window.revapi10initTry === undefined
                                    ? 0
    ...
    $("[data-tag='mouse']").on("click", function () {
